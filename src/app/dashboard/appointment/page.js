...
const Appointment = () => {
  return (
    <div>
      ...
      <div className="grid grid-cols-[auto_400px] p-4 min-h-screen">
        {/* content */}
        <AppointmentContent />
        {/* sidebar */}
        <div className="border-l-2 border-t-2 px-6 py-2 flex flex-col space-y-8">
          {/* map */}
          <div className="flex flex-col border-2 rounded-xl space-y-4 px-4 py-2 mt-8 w-[350px] h-[250px] text-white">
            ...
            <div className="overflow-hidden rounded-lg shadow-lg px-4 ">
              <iframe
