...
const Gallery = () => {
  return (
    <section className="md:mb-52 min-h-screen text-white">
      {/* intro */}
      <div className="flex flex-col items-center justify-center text-white gap-2 py-8 mb-20">
      ...
      <div className="flex max-w-[1800px] mx-auto justify-between items-center space-x-8 mb-20 px-4">
        ...
        <div className="md:text-[100px] text-4xl font-thin">
          <BsArrowRight />
        </div>
      </div>
      ...
      <div class="text-center mt-12 flex items-center justify-center ">
        <button class=" flex items-center md:text-2xl text-lg tracking-widest bg-gradient-to-r from-[#AE67FA] to-[#F49867] text-white font-thin px-8 py-2 rounded-full hover:scale-105 transition-transform">
          View Gallery
          <span class="ml-4 md:text-[60px] text-2xl font-thin">
            <BsArrowRight />
          </span>
        </button>
      </div>
